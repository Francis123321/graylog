  ...
  module.exports = merge(webpackConfig, {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin({ patterns: [
        { from: 'config.js' },
        { from: 'topologyBox/css/app.a0fd8134.css', to: 'css' },
        { from: 'topologyBox/js/app.f1f3e5d2.js', to: 'js' },
        { from: 'topologyBox/js/chunk-vendors.626e3c0f.js', to: 'js' },
        { from: 'topologyBox/static/img/backgroundCover.png', to: 'static/img' },
        { from: 'topologyBox/static/json/hostData.json', to: 'static/json' },
        { from: 'topologyBox/static/model/host.fbx', to: 'static/model' },
        { from: 'topologyBox/static/model/host1.fbx', to: 'static/model' },
        { from: 'topologyBox/static/model/host2.fbx', to: 'static/model' },
        { from: 'topologyBox/static/model/port.fbx', to: 'static/model' },
        { from: 'topologyBox/static/video/background.mp4', to: 'static/video' },
      ] }),
